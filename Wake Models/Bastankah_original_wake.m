function [Uw, V_inflow] = Bastankah_original_wake(x_grid,y_grid,z_grid,Ui,turbine,environment,xh,yh,turbine_number,comp_level,weights)
%The original Bastankah Port Agel model.  [Uw V_inflow A]
%
% Methodology from:
...
if nargin == 11 && comp_level ~= 0 && isempty(weights)
